...
class ScheduleType:
    ...
    def class_model(self, info: strawberry.Info[Context]) -> Annotated[
        ...
        return info.context.schedule_loader.class_loader.load((self.id, tuple(fields)))  # type: ignore
    ...
    def content(self, info: strawberry.Info[Context]) -> Annotated[
        ...
        fields = extract_fields(info)
        return info.context.schedule_loader.content_loader.load((self.id, tuple(fields)))  # type: ignore
