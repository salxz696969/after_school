...
Message: TypeAlias = (ConnectionInitMessage | ConnectionAckMessage | PingMessage | PongMessage | SubscribeMessage | NextMessage | ErrorMessage | CompleteMessage)
__all__ = ["CompleteMessage", "ConnectionAckMessage", "ConnectionInitMessage", "ErrorMessage", "Message", "NextMessage", "PingMessage", "PongMessage", "SubscribeMessage"]
