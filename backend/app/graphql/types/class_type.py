...
class ClassType:
    ...
    def users(self, info: strawberry.Info[Context]) -> List[
        ...
        return info.context.class_loader.user_loader.load((self.id, tuple(fields)))  # type: ignore
    ...
    def subjects(self, info: strawberry.Info[Context]) -> List[
        ...
        fields = extract_fields(info)
        return info.context.class_loader.subject_loader.load((self.id, tuple(fields)))  # type: ignore
    ...
    def assignments(self, info: strawberry.Info[Context]) -> List[
        ...
        fields = extract_fields(info)
        return info.context.class_loader.assignment_loader.load((self.id, tuple(fields)))  # type: ignore
    ...
    def schedules(self, info: strawberry.Info[Context]) -> List[
        ...
        fields = extract_fields(info)
        return info.context.class_loader.schedule_loader.load((self.id, tuple(fields)))  # type: ignore
    ...
    def announcements(self, info: strawberry.Info[Context]) -> List[
        ...
        fields = extract_fields(info)
        return info.context.class_loader.announcement_loader.load((self.id, tuple(fields)))  # type: ignore
